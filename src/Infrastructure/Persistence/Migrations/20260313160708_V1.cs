        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceRule_DayOfMonth = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_DaysOfWeek = table.Column<int[]>(type: "integer[]", nullable: false),
                    RecurrenceRule_EndsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RecurrenceRule_Frequency = table.Column<int>(type: "integer", nullable: false),
                    RecurrenceRule_Interval = table.Column<int>(type: "integer", nullable: false),
                    RecurrenceRule_MonthOfYear = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_OccurrenceCount = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_StartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    LastModifiedBy = table.Column<Guid>(type: "uuid", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoalTags", x => new { x.GoalsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_GoalTags_Goals_GoalsId",
                        column: x => x.GoalsId,
                        principalTable: "Goals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoalTags_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchVector = table.Column<NpgsqlTsVector>(type: "tsvector", nullable: false)
                        ...
                        .Annotation("Npgsql:TsVectorProperties", new[] { "Title", "Notes" }),
                    RecurrenceRule_DayOfMonth = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_DaysOfWeek = table.Column<int[]>(type: "integer[]", nullable: true),
                    RecurrenceRule_EndsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    RecurrenceRule_Frequency = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_Interval = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_MonthOfYear = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_OccurrenceCount = table.Column<int>(type: "integer", nullable: true),
                    RecurrenceRule_StartsAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Created = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TagsId = table.Column<Guid>(type: "uuid", nullable: false),
                    TaskItemsId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskItemTags", x => new { x.TagsId, x.TaskItemsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskItemTags_Tasks_TaskItemsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItemTags_TaskItemsId",
                table: "TaskItemTags",
                column: "TaskItemsId");
